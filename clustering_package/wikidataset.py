...
class WikiCorpus:
    ...
    def set_cluster_info(self, path, d_min=2):
        ...
        self.label2topic = utils.read_data(
    ...
    def set_type_mask(self):
        ...
        self.type_mask = np.array(self.type_mask)
